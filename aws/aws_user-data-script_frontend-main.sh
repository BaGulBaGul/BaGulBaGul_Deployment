...
#실행권한 부여
chmod +x ./scripts/amazonlinux2023_init_docker.sh ./scripts/amazonlinux2023_init_gpg.sh ./scripts/amazonlinux2023_init_openssl.sh ./scripts/amazonlinux2023_init_git-crypt.sh ./scripts/amazonlinux2023_init_swapfile_4GB.sh ./scripts/clone-decrypt_config-repository.sh
#docker 설치
echo "================ 도커 설치 ================"
...
#swapfile 2GB 설정
echo "================ 스왑메모리 4GB 설정 ================"
source ./scripts/amazonlinux2023_init_swapfile_4GB.sh
